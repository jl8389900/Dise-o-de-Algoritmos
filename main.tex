...
% \setmainfont[
% Ligatures=TeX,
% BoldFont=Slimbach Bold.ttf,
% ItalicFont=Slimbach Italic.ttf,
% BoldItalicFont=Slimbach Bold Italic.ttf,
% ]{Slimbach Regular.ttf}
...
\paragraph{Solución} Una forma natural de empezar a pensar en este problema es
suponer que la afirmación es falsa y tratar de obtener una contradicción.
...
\marginpar{
\includegraphics[width=\marginparwidth]{Imagenes-Capitulo7/figura_7_1.jpg}
\captionof{figure}{Un grafo bipartito.}
